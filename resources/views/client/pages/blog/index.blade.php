...
<style>
    ...
    .comment-items {
        padding-left: 0px; /* Xóa khoảng cách thụt vào của danh sách */
                    ...
                    <div class="blog">
                        ...
                        <div class="comments-box">
                            ...
                            <ul class="theme-scrollbar">
                                ...
                                @include('client.pages.blog.comment_render', ['comment' => $comment])
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <form action="{{ route('blog.comment.store', $article->id) }}" method="POST">
                            ...
                            <div class="row gy-3 message-box">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" name="comment" rows=""
